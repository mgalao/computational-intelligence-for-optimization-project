"""
This module contains various mutation functions for modifying the representation of individuals in a genetic algorithm.
...
def n_swap_mutation(individual, n_swaps=2):
    """
    ...
    # Update the individual's representation
    individual.repr = new_representation

    return individual

def scramble_mutation(individual, max_segment_length=4):
    """
...
def prime_slot_swap_mutation(individual):
    """
...
def preserve_best_slots_mutation(individual, keep_ratio=0.5):
    """
